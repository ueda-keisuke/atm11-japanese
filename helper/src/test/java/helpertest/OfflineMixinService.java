...
public final class OfflineMixinService extends MixinServiceAbstract
    ...
    @Override public Class<?> findClass(String name, boolean initialize) throws ClassNotFoundException {
        if (name.equals("appeng.items.tools.fluix.FluixSmithingTemplateItem") || name.equals("net.neoforged.neoforge.server.command.generation.GenerationBar") || name.startsWith("com.yogpc.qp.machine.") || name.startsWith("com.direwolf20.mininggadgets.client.screens.MiningSettingScreen")
